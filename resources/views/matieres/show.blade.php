...
<body class="bg-[#f8fafc] text-slate-900 font-sans overflow-x-hidden transition-colors duration-300">
    ...
    <nav class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 py-4 px-4 md:px-8 flex justify-between items-center sticky top-0 z-50 transition-colors duration-300">
        <a href="/" class="flex items-center gap-2 group">
            ...
            <span class="font-black text-slate-800 dark:text-slate-100 tracking-tight">RESSOURCES</span>
        </a>
        <a href="{{ route('semestre.show', $matiere->semestre_id) }}" class="text-slate-500 dark:text-slate-300 hover:text-blue-600 font-bold transition flex items-center gap-2">
