...
<head>
    ...
    <title><?php echo e($page->titre); ?> - MIO</title>
...
<body class="bg-white text-slate-900 font-sans">
    ...
    <header class="py-20 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center md:text-left">
            <h1 class="text-4xl md:text-7xl font-black tracking-tighter leading-tight uppercase"><?php echo e($page->titre); ?></h1>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page->cover_image): ?>
        <div class="max-w-4xl mx-auto px-6 py-8">
            <img src="<?php echo e(asset('storage/' . $page->cover_image)); ?>"
                 alt="<?php echo e($page->titre); ?>"
    ...
    <main class="max-w-4xl mx-auto py-20 px-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page->slug === 'a-propos' && isset($settings['univ_map'])): ?>
            <div class="mt-24">
    ...
    <footer class="bg-slate-50 py-16 px-8 border-t border-slate-100">
        <div class="max-w-4xl mx-auto text-center">
            <p class="text-slate-400 text-xs font-black uppercase tracking-[0.3em]">
                MIO Ressources &bull; Université Iba Der Thiam &bull; <?php echo e(date('Y')); ?>
...
<?php /**PATH C:\Users\Mamad\Documents\Dossier Mio-Ressource\mio_ressources\resources\views/pages/show.blade.php ENDPATH**/ ?>