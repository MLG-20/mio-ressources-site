...
<body class="bg-[#f8fafc] dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300">
    ...
    <nav class="bg-white dark:bg-slate-900 text-slate-800 dark:text-white py-4 px-4 md:px-8 flex justify-between items-center sticky top-0 z-50 border-b border-slate-200 dark:border-slate-700 transition-colors duration-300">
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('teacher.dashboard') }}" class="hidden md:flex bg-slate-100 dark:bg-white/10 hover:bg-slate-200 dark:hover:bg-white/20 px-3 md:px-4 py-2 rounded-xl text-xs font-bold uppercase transition">
                ← Dashboard
            </a>
        </div>
