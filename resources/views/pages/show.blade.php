...
<body class="bg-white text-slate-900 font-sans overflow-x-hidden transition-colors duration-300">
    ...
    {{-- FORMULAIRE DE CONTACT (uniquement sur la page À propos) --}}
    @if($page->slug === 'a-propos')
        <section class="mt-24 mb-16">
            <div class="max-w-2xl mx-auto bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl border-4 border-blue-100 dark:border-slate-700 p-8 md:p-12">
