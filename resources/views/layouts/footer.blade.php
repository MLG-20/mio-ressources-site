<footer class="bg-slate-100 dark:bg-slate-950 text-slate-800 dark:text-white py-20 px-8 border-t border-slate-200 dark:border-white/5 transition-colors duration-300">
